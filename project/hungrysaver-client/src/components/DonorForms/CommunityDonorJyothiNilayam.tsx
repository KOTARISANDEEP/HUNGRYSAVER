...
interface CommunityRequest {
  ...
  urgency: string;
  description: string;
  initiative: string; // Added for Firestore
  submittedAt: string;
  source: string;
}

const CommunityDonorJyothiNilayam: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-gray-800 rounded-xl p-8 mt-8 shadow-lg">
      <h2 className="text-2xl font-bold text-yellow-400 mb-6">🏠 Jyothi Nilayam - Community Donor Response</h2>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              <label className="block text-gray-400 text-sm">Current Address</label>
            ...
            <div>
              <label className="block text-gray-400 text-sm">Shelter Type Needed</label>
              <input className="w-full bg-gray-700 rounded px-3 py-2 text-white" value={request.shelterTypeNeeded} readOnly />
            </div>
            <div>
              <label className="block text-gray-400 text-sm">Number of People/Animals</label>
              <input className="w-full bg-gray-700 rounded px-3 py-2 text-white" value={request.numberOfPeopleAnimals} readOnly />
            </div>
            <div>
              <label className="block text-gray-400 text-sm">Duration Needed</label>
              <input className="w-full bg-gray-700 rounded px-3 py-2 text-white" value={request.durationNeeded} readOnly />
            </div>
            <div className="md:col-span-2">
        ...
        <button type="submit" className="w-full bg-yellow-600 hover:bg-yellow-700 text-white font-bold py-3 rounded-lg transition-colors" disabled={loading}>
...
export default CommunityDonorJyothiNilayam; 