...
const CommunityDonorAnnamitraSeva: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-gray-800 rounded-xl p-8 mt-8 shadow-lg">
      <h2 className="text-2xl font-bold text-green-400 mb-6">🍛 Annamitra Seva - Community Donor Response</h2>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-gray-400 text-sm">Number of People</label>
              <input className="w-full bg-gray-700 rounded px-3 py-2 text-white" value={request.numberOfPeople} readOnly />
            </div>
            <div>
              <label className="block text-gray-400 text-sm">Dietary Restrictions</label>
              <input className="w-full bg-gray-700 rounded px-3 py-2 text-white" value={request.dietaryRestrictions} readOnly />
            </div>
            <div>
              <label className="block text-gray-400 text-sm">Meal Frequency</label>
              <input className="w-full bg-gray-700 rounded px-3 py-2 text-white" value={request.mealFrequency} readOnly />
            </div>
          </div>
        </div>
        {/* Donor Information */}
        ...
        <button type="submit" className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 rounded-lg transition-colors" disabled={loading}>
...
export default CommunityDonorAnnamitraSeva; 